     ...
     <a href='/'>
      ...
      />
        ...
        <div className='col-span-10 px-10'>
          ...
          />
          <button className='biorder border-gray-400 px-5 py-2 rounded-r-full bg-gray-200'>🔍</button>
        </div>
        <div>
            <img className='h-12'
            alt='user' 
            src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT2yJWVwI9ZFnJhI3FIB5wIK4Ys7B8J-u5hfQ&s'
            />
        </div>
    </div>
  );
